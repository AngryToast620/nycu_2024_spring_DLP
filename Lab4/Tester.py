...
class Test_model(VAE_Model):
    ...
    def load_checkpoint(self):
        if self.args.ckpt_path != None:
            ...
            weight_files = [Path(r'.\save_models\no_tfr_Cyclical\epoch=87.ckpt'), Path(r'.\save_models\no_tfr_Cyclical\epoch=86.ckpt'), Path(r'.\save_models\no_tfr_Cyclical\epoch=85.ckpt')]
            models = []
            for file in weight_files:
                model = VAE_Model(self.args)  
            ...
            torch.save(self.state_dict(), 'averaged_weights.pth')
